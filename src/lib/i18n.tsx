...
const zhCN = {
  ...
  "shell.desc.dashboard": "查看需要处理的实例、时长和费用",
  "shell.desc.tasks": "筛选、释放和管理远程实例",
  "shell.desc.taskDetail": "对照状态、路径、日志和终端",
  "shell.desc.scheduledTasks": "本地定时创建，不是后端调度器",
  "shell.desc.taskTemplates": "保存常用创建参数并批量生成",
  "shell.desc.storage": "浏览、上传和下载远程文件",
  "shell.desc.images": "查看自定义与系统镜像",
  "shell.desc.runLogs": "本地操作记录，含 CLI 与 MCP",
  "shell.desc.settings": "连接、通知、终端与本地数据",
  "shell.loggedIn": "已登录",
  "shell.logout": "退出",
  "shell.sidebar": "侧边栏",
  "shell.status": "状态",
  ...
  "shell.shortcutsTaskMove": "任务列表：上下移动选中行",
  "shell.shortcutsTaskOpen": "任务列表：打开详情",
  "shell.shortcutsTaskLog": "任务列表：打开日志",
  "shell.shortcutsTaskTerminal": "任务列表：打开连接信息",
  "shell.shortcutsTaskRelease": "任务列表：释放当前实例",
  ...
  "settings.apiBaseInsecure": "远程明文 HTTP 不安全。建议改用 HTTPS，或本机隧道 http://127.0.0.1:.../api",
  "settings.monitorUrlInsecure": "远程明文监控地址不安全。建议改用 HTTPS，或本机隧道 http://127.0.0.1:...",
  "settings.transportInsecureWarning": "当前使用远程明文 HTTP。密码摘要与 Token 可被重放，请仅在可信网络使用；有条件时优先改用 HTTPS 或本机隧道。",
  ...
  "shell.transportBlocked": "API 地址不被允许，请前往设置检查。",
  "login.transportBlocked": "当前 API 地址不被允许。请先在 API 设置中检查地址格式。",
  "settings.derivedTitle": "当前派生地址",
  "settings.scope": "生效范围",
  "settings.scopeDescription": "设置按当前登录账号独立保存。保存后，任务、镜像、存储、登录校验、监控链接和派生连接信息会使用该账号的配置。",
  "settings.backToLogin": "返回登录",
  "settings.sshTitle": "SSH 终端",
  "settings.sshDescription": "配置应用内 SSH 连接参数与终端外观（按账号独立）",
  "settings.sshConnection": "连接参数",
  "settings.sshDefaultUsername": "默认用户名",
  "settings.sshDefaultPassword": "默认密码",
  "settings.sshDefaultPasswordPlaceholder": "留空则使用当前登录用户名",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "shell.desc.dashboard": "See instances that need attention, runtime, and cost",
  "shell.desc.tasks": "Filter, release, and manage remote instances",
  "shell.desc.taskDetail": "Compare status, paths, logs, and terminal access",
  "shell.desc.scheduledTasks": "Local deferred creation, not a backend scheduler",
  "shell.desc.taskTemplates": "Reuse create parameters and generate batches",
  "shell.desc.storage": "Browse, upload, and download remote files",
  "shell.desc.images": "Inspect custom and system images",
  "shell.desc.runLogs": "Local operation history, including CLI and MCP",
  "shell.desc.settings": "Connection, notifications, terminal, and local data",
  ...
  "shell.shortcutsTaskMove": "Tasks: move selection",
  "shell.shortcutsTaskOpen": "Tasks: open details",
  "shell.shortcutsTaskLog": "Tasks: open logs",
  "shell.shortcutsTaskTerminal": "Tasks: open connection info",
  "shell.shortcutsTaskRelease": "Tasks: release current instance",
  ...
  "settings.apiBaseInsecure": "Remote cleartext HTTP is insecure. Prefer HTTPS, or a local tunnel such as http://127.0.0.1:.../api",
  "settings.monitorUrlInsecure": "Remote cleartext monitor URLs are insecure. Prefer HTTPS, or a local tunnel such as http://127.0.0.1:...",
  "settings.transportInsecureWarning": "Remote cleartext HTTP is in use. Password digests and tokens are replayable — use only on trusted networks. Prefer HTTPS or a local tunnel when available.",
  ...
  "shell.transportBlocked": "The API URL is not allowed. Open Settings and check the address.",
  "login.transportBlocked": "The current API URL is not allowed. Open API settings and check the address format first.",
  "settings.derivedTitle": "Derived URLs",
  "settings.scope": "Applies to",
  "settings.scopeDescription": "Settings are stored per signed-in account. After saving, tasks, images, storage, sign-in checks, monitor links, and derived connection info use this account's configuration.",
  "settings.backToLogin": "Back to sign in",
  "settings.sshTitle": "SSH Terminal",
  "settings.sshDescription": "Configure in-app SSH connection parameters and terminal appearance (per account)",
  "settings.sshConnection": "Connection",
  "settings.sshDefaultUsername": "Default username",
  "settings.sshDefaultPassword": "Default password",
  "settings.sshDefaultPasswordPlaceholder": "Leave empty to use the current login username",
