...
const zhCN = {
  ...
  "settings.scope": "生效范围",
  "settings.scopeDescription": "设置按当前登录账号独立保存。保存后，任务、镜像、存储、登录校验、监控链接和 WebSSH 地址会使用该账号的配置。",
...
const enUS: Record<TranslationKey, string> = {
  ...
  "settings.scopeDescription": "Settings are stored per signed-in account. After saving, tasks, images, storage, sign-in checks, monitor links, and WebSSH URLs use this account's configuration.",
